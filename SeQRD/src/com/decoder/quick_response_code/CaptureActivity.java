...
import com.decoder.quick_response_code.result.ResultHandler;
import com.decoder.quick_response_code.result.ResultHandlerFactory;
...
public class CaptureActivity extends DecoderActivity {
    ...
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        ...
        formatTextView.setVisibility(View.INVISIBLE);
        ...
        if (metadata != null) {
            ...
            if (metadataText.length() > 0) {
                ...
                metaTextView.setVisibility(View.INVISIBLE);
                metaTextViewLabel.setVisibility(View.INVISIBLE);
            }
        }
        CharSequence displayContents = resultHandler.getDisplayContents();
        Intent returnIntent=new Intent();
        returnIntent.putExtra("result", displayContents);
